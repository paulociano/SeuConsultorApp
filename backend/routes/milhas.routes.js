...
router.post('/milhas/carteiras', carteiraValidation, checkValidation, milhasController.createCarteira);
router.put('/milhas/carteiras/:id', idParamValidation, carteiraValidation, checkValidation, milhasController.updateCarteira);
router.delete('/milhas/carteiras/:id', idParamValidation, checkValidation, milhasController.deleteCarteira);
...
router.put('/milhas/metas/:id', idParamValidation, metaMilhasValidation, checkValidation, milhasController.updateMeta);
