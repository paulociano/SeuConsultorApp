...
const objetivoValidation = [
  ...
  body('investimentosLinkados', 'Investimentos lincados deve ser um array de números')
    .optional()
    .isArray(),
  body('investimentosLinkados.*', 'Cada item em investimentosLinkados deve ser um ID numérico')
    .optional()
    .isInt(),
];
...
router.put(
  ...
  objetivoValidation,
  checkValidation,
  objetivosController.updateObjetivo
);
router.delete(
  '/objetivos/:id',
  idParamValidation,
