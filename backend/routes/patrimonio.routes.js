...
router.put('/ativos/:id', idParamValidation, patrimonioValidation, checkValidation, patrimonioController.updateAtivo);
...
router.put('/dividas/:id', idParamValidation, patrimonioValidation, checkValidation, patrimonioController.updateDivida);
router.delete('/dividas/:id', idParamValidation, checkValidation, patrimonioController.deleteDivida);
