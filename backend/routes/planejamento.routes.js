...
router.post(
  ...
  jsonDataValidation,
  checkValidation,
  planejamentoController.saveAposentadoria
);
...
router.post(
  ...
  jsonDataValidation,
  checkValidation,
  planejamentoController.saveSimuladorPgbl
);

// --- Rotas de Aquisições ---
router.get(
  '/aquisicoes/:tipo',
  tipoAquisicaoValidation,
  checkValidation,
  planejamentoController.getAquisicoes
);
router.post(
  '/aquisicoes/:tipo',
  tipoAquisicaoValidation,
  jsonArrayValidation,
  checkValidation,
  planejamentoController.saveAquisicoes
);
