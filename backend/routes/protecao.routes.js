...
router.post('/protecao/invalidez', protecaoInvalidezValidation, checkValidation, protecaoController.createInvalidez);
router.put('/protecao/invalidez/:id', idParamValidation, protecaoInvalidezValidation, checkValidation, protecaoController.updateInvalidez);
router.delete('/protecao/invalidez/:id', idParamValidation, checkValidation, protecaoController.deleteInvalidez);

// --- Rotas para Despesas Futuras ---
router.post('/protecao/despesas', protecaoDespesasValidation, checkValidation, protecaoController.createDespesa);
router.put('/protecao/despesas/:id', idParamValidation, protecaoDespesasValidation, checkValidation, protecaoController.updateDespesa);
router.delete('/protecao/despesas/:id', idParamValidation, checkValidation, protecaoController.deleteDespesa);

// --- Rotas para Patrimonial ---
router.post('/protecao/patrimonial', protecaoPatrimonialValidation, checkValidation, protecaoController.createPatrimonial);
router.put('/protecao/patrimonial/:id', idParamValidation, protecaoPatrimonialValidation, checkValidation, protecaoController.updatePatrimonial);
router.delete('/protecao/patrimonial/:id', idParamValidation, checkValidation, protecaoController.deletePatrimonial);
